...
//   and displays a count of MAP events, once per Server polling cycle. 
...
void CMFCEventWaitDlg::StartReadThread()
{
  ...
  //** open the event used by the Server to signal to a client that more MAP events are ready to be read
...
//** thread when the Server has signalled that it has a batch of MAP events ready for reading
